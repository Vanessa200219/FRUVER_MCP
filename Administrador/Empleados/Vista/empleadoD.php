  ...
  <a class="eliminar" href="../Controlador/eliminar.php?id=<?php echo $dato->NumerodeDocumento; ?>">Eliminar</a>
		...
		<table class="table__1">
				<tbody class="empleado_contenido">
                    ...
                    <tr>
                        <td class="titulo_empleado">Numero Seguro </td>
                        <td><?php echo $dato->NumeroSeguroDom; ?></td>
                    </tr>


                    <tr>
                        <td class="titulo_empleado">Numero Seguro Vehiculo  </td>
                        <td><?php echo $dato->NumeroSeguroVehi; ?></td>
                    </tr>


                    <tr>
                        <td class="titulo_empleado">Valor Domicilio  </td>
                        <td><?php echo $dato->ValorDomicilio; ?></td>
                    </tr>


                    <tr>
                        <td class="titulo_empleado">Fecha Ingreso</td>
